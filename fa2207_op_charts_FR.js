...
d3.csv(csv_dir_url + "fig6.5_data.csv").then(d => {
  ...
  const fig6_5 =
    Plot.plot({
      ...
      color: {legend: true, domain: ["Rémunération du personnel enseignant", "Éducation par du personnel non enseignant", "Administration", "Transports", "Logement des élèves", "Infrastructure", "Autres dépenses"], range: ["#255FD5", "#93BBF7", fao_pink,"#D4E3FC", "#1A2B4A", '#3D5892', fao_green]}
    })
